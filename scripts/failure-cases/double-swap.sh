...
teamAddr=$(cat ~/$BLOCKCHAIN_PREFIX/marketplace.addr)
signingKey=~/$BLOCKCHAIN_PREFIX/buyer.skey
value1="1724100 lovelace + 1 d6cfdbedd242056674c0e51ead01785497e3a48afbbb146dc72ee1e2.746f6b656e31"
value2="1724100 lovelace + 1 380eab015ac8e52853df3ac291f0511b8a1b7d9ee77248917eaeef10.746f6b656e31"
sellerAmount="8000000 lovelace"
teamAmount="1000000 lovelace"
...
projectAddr=$(cat ~/$BLOCKCHAIN_PREFIX/royalities.addr)
projectAmount="1000000 lovelace"
